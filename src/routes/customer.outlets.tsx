...
export const Route = createFileRoute("/customer/outlets")({
  head: () => ({
    meta: [
      { title: "Choose Outlet — Kosia Rajula Ruchulu" },
      { name: "description", content: "Pick your nearest outlet to browse the menu." },
    ],
  }),
  component: CustomerOutletsScreen,
});
