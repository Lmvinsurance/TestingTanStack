...
export const Route = createFileRoute("/brands")({
  head: () => ({
    meta: [
      { title: "Choose Your Experience — Telugu Food Club" },
      {
        name: "description",
        content:
          "Choose between Kosta Rajula Ruchulu restaurant meals and Theeyaga-Kaaranga traditional pickles, sweets and snacks.",
      },
      { property: "og:title", content: "Choose Your Experience — Telugu Food Club" },
      {
        property: "og:description",
        content: "Discover authentic Telugu flavors your way.",
      },
    ],
  }),
