...
export const Route = createFileRoute("/splash")({
  head: () => ({
    meta: [
      { title: "Kosta Rajula Ruchulu — Authentic Telugu Flavours" },
      {
        name: "description",
        content:
          "Authentic Andhra & Telangana cuisine delivered fresh. Heritage Telugu flavours, prepared with love.",
      },
      { property: "og:title", content: "Kosta Rajula Ruchulu" },
      {
