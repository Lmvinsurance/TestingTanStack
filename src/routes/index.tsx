...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Telugu Food Club — Authentic Andhra & Telangana Cuisine" },
      {
        name: "description",
        content:
          "A premium Telugu food ecosystem. Order traditional meals from Kosta Rajula Ruchulu and shop heritage pickles, sweets and snacks from Theeyaga-Kaaranga.",
      },
      { property: "og:title", content: "Telugu Food Club" },
      {
        property: "og:description",
        content: "Authentic Telugu flavours, delivered fresh.",
      },
    ],
  }),
  component: Landing,
