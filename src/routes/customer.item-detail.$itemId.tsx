...
export const Route = createFileRoute("/customer/item-detail/$itemId")({
  head: () => ({ meta: [{ title: "Item — Kosia Rajula Ruchulu" }] }),
          ...
          <section className="mt-6">
            ...
            <div className="mt-3 -mx-5 overflow-x-auto px-5 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="flex gap-3">
                {related.map((r) => (
                  <Link key={r.id} to="/customer/item-detail/$itemId" params={{ itemId: r.id }}
