...
function WalkinPage() {
  ...
  customer_name: "ttytytytytyt",
  total_amount: 236,
  order_status: "PENDING",
  order_items: [
    {
      item_id: 318,
      title: "Amalapuram Layer Kodi Vepudu",
      description: "",
      item_type: "NonVeg",
      is_available: true,
      image_url:
        "https://itsonme.s3.ap-south-1.amazonaws.com/uploads/1743573085247_high-angle-shot-delicious-hot-spicy-dish-called-drums-heaven-table.jpg",
      variants: {
        Single: 200
      },
      variant: "Single",
